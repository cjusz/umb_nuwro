...
args(const char* p="nuwro",
  const char* i="params.txt",
  const char* o="eventsout.root") : program(p), input(i), output(o){}
...
{
  cout << "usage: " << program
    << " [-i input_paramaters_file] [-o output_root_file] [-p \"param1="
