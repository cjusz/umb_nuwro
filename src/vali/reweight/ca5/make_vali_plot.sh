...
#thetamu
echo "VarToPlot FS_mu_ct; FS_mu_ct.XAxisTitle = \"cos#it{#theta}^{#mu}\"; FS_mu_ct.VariableName = \"ctmu\"; FS_mu_ct.DialName = \"${DIALNAME}\"; FS_mu_ct.DialPrettyName = \"${DIALPRETTYNAME}\"; FS_mu_ct.DialUnits = \"\"; FS_mu_ct.PlotString = \"HMFSLepton_4Mom.CosTheta()\"; FS_mu_ct.SelectionString = \"(HMFSLepton_PDG==13)&&(NeutConventionReactionCode==11)\"; FS_mu_ct.DialValm2 = \"0.99\"; FS_mu_ct.DialVal0 = \"1.19\"; FS_mu_ct.DialVal2 = \"1.39\"; FS_mu_ct.NBins = 50; FS_mu_ct.XBinMin = -1; FS_mu_ct.XBinMax = 1; FS_mu_ct.LegX1 = 0.36; FS_mu_ct.LegY1 = 0.5; FS_mu_ct.LegX2 = 0.89; FS_mu_ct.LegY2 = 0.89; FS_mu_ct.LogY = true; PlotVar(FS_mu_ct);" >> Plot_${DIALNAME}_Vars.cc

#pq2
echo "VarToPlot FS_q2; FS_q2.XAxisTitle = \"#it{Q}^{2} (GeV^2/#it{c}^{2})\"; FS_q2.VariableName = \"q2\"; FS_q2.DialName = \"${DIALNAME}\"; FS_q2.DialPrettyName = \"${DIALPRETTYNAME}\"; FS_q2.DialUnits = \"\"; FS_q2.PlotString = \"FourMomentum_Transfer.Mag2()\"; FS_q2.SelectionString = \"(HMFSLepton_PDG==13)&&(NeutConventionReactionCode==11)\"; FS_q2.DialValm2 = \"0.99\"; FS_q2.DialVal0 = \"1.19\"; FS_q2.DialVal2 = \"1.39\"; FS_q2.NBins = 50; FS_q2.XBinMin = -4; FS_q2.XBinMax = 0; FS_q2.LegX1 = 0.36; FS_q2.LegY1 = 0.5; FS_q2.LegX2 = 0.89; FS_q2.LegY2 = 0.89; FS_q2.LogY = false; PlotVar(FS_q2);" >> Plot_${DIALNAME}_Vars.cc

#qhadrmasscut2
echo "VarToPlot hadrmass; hadrmass.XAxisTitle = \"#it{W} (GeV/#it{c}^2)\"; hadrmass.VariableName = \"hadrmass\"; hadrmass.DialName = \"${DIALNAME}\"; hadrmass.DialPrettyName = \"${DIALPRETTYNAME}\"; hadrmass.DialUnits = \"\"; hadrmass.PlotString = \"FS_HadrMass\"; hadrmass.SelectionString = \"(HMFSLepton_PDG==13)&&(NeutConventionReactionCode==11)&&(FS_HadrMass<2.0)\"; hadrmass.DialValm2 = \"0.99\"; hadrmass.DialVal0 = \"1.19\"; hadrmass.DialVal2 = \"1.39\"; hadrmass.NBins = 50; hadrmass.XBinMin = 1; hadrmass.XBinMax = 2; hadrmass.LegX1 = 0.36; hadrmass.LegY1 = 0.5; hadrmass.LegX2 = 0.89; hadrmass.LegY2 = 0.89; hadrmass.LogY = false; PlotVar(hadrmass);" >> Plot_${DIALNAME}_Vars.cc


#phmpi
echo "VarToPlot FS_hmpi_p; FS_hmpi_p.XAxisTitle = \"#it{p}^{#pi,Highest} (GeV/#it{c})\"; FS_hmpi_p.VariableName = \"phmpi\"; FS_hmpi_p.DialName = \"${DIALNAME}\"; FS_hmpi_p.DialPrettyName = \"${DIALPRETTYNAME}\"; FS_hmpi_p.DialUnits = \"\"; FS_hmpi_p.PlotString = \"HMPion_4Mom.Vect().Mag()\"; FS_hmpi_p.SelectionString = \"(HMPion_PDG!=0)&&(NeutConventionReactionCode==11)\"; FS_hmpi_p.DialValm2 = \"0.99\"; FS_hmpi_p.DialVal0 = \"1.19\"; FS_hmpi_p.DialVal2 = \"1.39\"; FS_hmpi_p.NBins = 50; FS_hmpi_p.XBinMin = 0; FS_hmpi_p.XBinMax = 2.5; FS_hmpi_p.LegX1 = 0.36; FS_hmpi_p.LegY1 = 0.5; FS_hmpi_p.LegX2 = 0.89; FS_hmpi_p.LegY2 = 0.89; FS_hmpi_p.LogY = false; PlotVar(FS_hmpi_p);" >> Plot_${DIALNAME}_Vars.cc
#thetahmpi
echo "VarToPlot FS_hmpi_ct; FS_hmpi_ct.XAxisTitle = \"cos#it{#theta}^{#pi,Highest}\"; FS_hmpi_ct.VariableName = \"cthmpi\"; FS_hmpi_ct.DialName = \"${DIALNAME}\"; FS_hmpi_ct.DialPrettyName = \"${DIALPRETTYNAME}\"; FS_hmpi_ct.DialUnits = \"\"; FS_hmpi_ct.PlotString = \"HMPion_4Mom.CosTheta()\"; FS_hmpi_ct.SelectionString = \"(HMPion_PDG!=0)&&(NeutConventionReactionCode==11)\"; FS_hmpi_ct.DialValm2 = \"0.99\"; FS_hmpi_ct.DialVal0 = \"1.19\"; FS_hmpi_ct.DialVal2 = \"1.39\"; FS_hmpi_ct.NBins = 50; FS_hmpi_ct.XBinMin = -1; FS_hmpi_ct.XBinMax = 1; FS_hmpi_ct.LegX1 = 0.36; FS_hmpi_ct.LegY1 = 0.5; FS_hmpi_ct.LegX2 = 0.89; FS_hmpi_ct.LegY2 = 0.89; FS_hmpi_ct.LogY = true; PlotVar(FS_hmpi_ct);" >> Plot_${DIALNAME}_Vars.cc

#phmp
echo "VarToPlot FS_hmp_p; FS_hmp_p.XAxisTitle = \"#it{p}^{p,Highest} (GeV/#it{c})\"; FS_hmp_p.VariableName = \"phmp\"; FS_hmp_p.DialName = \"${DIALNAME}\"; FS_hmp_p.DialPrettyName = \"${DIALPRETTYNAME}\"; FS_hmp_p.DialUnits = \"\"; FS_hmp_p.PlotString = \"HMProton_4Mom.Vect().Mag()\"; FS_hmp_p.SelectionString = \"(HMProton_PDG!=0)&&(NeutConventionReactionCode==11)\"; FS_hmp_p.DialValm2 = \"0.99\"; FS_hmp_p.DialVal0 = \"1.19\"; FS_hmp_p.DialVal2 = \"1.39\"; FS_hmp_p.NBins = 50; FS_hmp_p.XBinMin = 0; FS_hmp_p.XBinMax = 2.5; FS_hmp_p.LegX1 = 0.36; FS_hmp_p.LegY1 = 0.5; FS_hmp_p.LegX2 = 0.89; FS_hmp_p.LegY2 = 0.89; FS_hmp_p.LogY = false; PlotVar(FS_hmp_p);" >> Plot_${DIALNAME}_Vars.cc
#thetahmp
echo "VarToPlot FS_hmp_ct; FS_hmp_ct.XAxisTitle = \"cos#it{#theta}^{p,Highest}\"; FS_hmp_ct.VariableName = \"cthmp\"; FS_hmp_ct.DialName = \"${DIALNAME}\"; FS_hmp_ct.DialPrettyName = \"${DIALPRETTYNAME}\"; FS_hmp_ct.DialUnits = \"\"; FS_hmp_ct.PlotString = \"HMProton_4Mom.CosTheta()\"; FS_hmp_ct.SelectionString = \"(HMProton_PDG!=0)&&(NeutConventionReactionCode==11)\"; FS_hmp_ct.DialValm2 = \"0.99\"; FS_hmp_ct.DialVal0 = \"1.19\"; FS_hmp_ct.DialVal2 = \"1.39\"; FS_hmp_ct.NBins = 50; FS_hmp_ct.XBinMin = -1; FS_hmp_ct.XBinMax = 1; FS_hmp_ct.LegX1 = 0.36; FS_hmp_ct.LegY1 = 0.5; FS_hmp_ct.LegX2 = 0.89; FS_hmp_ct.LegY2 = 0.89; FS_hmp_ct.LogY = true; PlotVar(FS_hmp_ct);" >> Plot_${DIALNAME}_Vars.cc
