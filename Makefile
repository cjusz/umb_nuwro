...
$(BIN)/nuwro2rootracker: $(EVENT_OBJS) src/nuwro2rootracker.o src/RooTrackerEvent.o
		 $(LINK.cc) $^ -o $@
...
$(BIN)/test_beam:	src/generatormt.o src/pdg.o src/test_beam.o  $(EVENT_OBJS) src/beamHist.o src/nd280stats.o
		$(LINK.cc) $^ -o $@
